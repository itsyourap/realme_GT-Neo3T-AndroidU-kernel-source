...
inner_dir := $(wildcard $(inner_mk_dir)/../realme_GT-Neo3T-AndroidU-vendor-source/vendor/oplus/kernel/*/oplus_wakelock_profiler.h)
...
$(shell ln -sf $(inner_mk_dir)/../realme_GT-Neo3T-AndroidU-vendor-source/vendor/oplus/kernel/$(inner_wakelock_dir) $(inner_mk_dir)/drivers/soc/oplus/owakelock)
$(shell ln -sf $(inner_mk_dir)/../realme_GT-Neo3T-AndroidU-vendor-source/vendor/oplus/kernel/$(inner_wakelock_dir)/oplus_wakelock_profiler.h $(inner_mk_dir)/include/soc/oplus/oplus_wakelock_profiler.h)
else
